...
$pdf->Cell(70);
$pdf->Cell(0, 10, 'S M K  I D N  B O A R D I N G  S C H O O L', 0, 0, 'C');
$pdf->Ln(14);
$pdf->Cell(70);
$pdf->SetFont('helvetica', 'I', 9);
$pdf->Cell(0, 10, 'Jl. Raya Dayeuh, Sukanegara, Kec. Jonggol, Kabupaten Bogor, Jawa Barat 16830 Telp. 0812-8004-0100', 0, 0, 'C');
$pdf->SetLineWidth(1);

...
<div class="container-fluid">
    ...
    <h1 class="h2 pt-4 text-gray-900 text-center text-uppercase">Selamat Datang di Dashboard Jurnal Guru</h1>
    <img src="<?= base_url('assets/img/idnlogo.png') ?>" alt="logo.png" width="240px" style="display: block; margin: auto;">
    <h1 class="h4 mb-5 text-gray-900 text-center">Sistem Jurnal Guru SMK IDN Boarding School</h1>
